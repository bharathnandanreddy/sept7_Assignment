    ...
    return(
        ...
        <table className="table table-bordered table-hover ">
            <thead>
                ...
                {props.checks['publisher'].checked?   <th style={{width: "25%"}} onClick={() => props.sortData("publisher")}>Manufacturer <img alt="img" className={classes.Sort} width="18px" src={sort} /></th>: null}
